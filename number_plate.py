...
class NumberPlate:
    ...
    def __drawText(
        ...
        print("Generated Text:", text)  # 生成されたテキストを表示
...
# # NumberPlateクラスのインスタンスを作成
# np_generator = NumberPlate()

# # # カテゴリをランダムに選ぶ（例えば、0から3の範囲でランダムに選ぶ）
# # category = random.randint(0, 3)

# # ナンバープレート画像を生成
# result_image = np_generator.generate(2)


# # 生成した画像を表示する
# cv2.imshow('Number Plate', result_image)
# cv2.waitKey(0)
